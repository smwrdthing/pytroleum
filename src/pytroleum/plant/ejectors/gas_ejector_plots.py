...
temperatures = [
    ...
    ejector.temperature.nozzle_exit - KELVIN_TO_CELSIUS,
    ejector.temperature.cyl_section_exit - KELVIN_TO_CELSIUS,
    ejector.temperature.diffuser_exit - KELVIN_TO_CELSIUS,
]

velocities = [
    ejector.velocity.active_inlet,
    ejector.velocity.nozzle_exit,
    ejector.velocity.cyl_section_exit,
    ejector.velocity.ejector_outlet,
]
