...
p("Действительная площадь сечения:", f"{wmd.actual_area:.4f}", "м²")
p("Действительная скорость набегания:", f"{wmd.actual_velocity:.3f}", "м/с")
p("Производительность:", f"{wmd.capacity:.4f}", "м³/с")
